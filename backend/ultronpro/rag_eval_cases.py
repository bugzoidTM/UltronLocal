...
DEFAULT_CASES = [
    {
        ...
        'task_type': 'debug',
        'expected_domains': ['rag_runtime_logs', 'rag_code'],
    ...
    },
    {
        ...
        'task_type': 'debug',
        'expected_domains': ['rag_runtime_logs', 'rag_project_docs'],
    ...
    },
    {
        ...
        'task_type': 'code',
        'expected_domains': ['rag_code', 'rag_facts'],
    ...
    },
    {
        ...
        'task_type': 'planning',
        'expected_domains': ['rag_project_docs', 'rag_user_memory'],
    ...
    },
    {
        ...
        'task_type': 'memory',
        'expected_domains': ['rag_user_memory', 'rag_project_docs'],
    ...
    },
    {
        ...
        'task_type': 'general',
        'expected_domains': ['rag_project_docs', 'rag_facts'],
    ...
    },
    {
        ...
        'task_type': 'debug',
        'expected_domains': ['rag_runtime_logs', 'rag_code', 'rag_project_docs'],
    ...
    },
    {
        ...
        'task_type': 'memory',
        'expected_domains': ['rag_user_memory'],
    ...
    },
    {
        ...
        'expected_domains': ['rag_project_docs', 'rag_code'],
