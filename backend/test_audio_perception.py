...
def test_authorized_voice_command_transcribes_routes_chat_and_discards_raw(tmp_path):
    ...
    async def run():
        return await audio_perception.handle_voice_command(
            ...
            bus_module=bus,
            client_metadata={"compressed": True, "compression_codec": "audio/webm;codecs=opus", "uploaded_bytes": 1200},
        )
    ...
    assert bus.events[0]["payload"]["client_metadata"]["compressed"] is True
