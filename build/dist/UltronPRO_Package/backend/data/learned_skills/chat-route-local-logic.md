# Rota local local_logic

## Resumo curto
Reutilizar a rota local local_logic para mensagens semelhantes antes de acionar raciocinio caro.
...
## Acao reutilizavel
- action_kind: local_logic
- status: candidate
- confidence: 0.470
- cognitive_status: local_skill
- transfer_status: untested
- transfer_score: 0.000
